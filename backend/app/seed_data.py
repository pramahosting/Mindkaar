"""
Seeds the database with characters + scenarios if they don't already exist.
Run automatically on startup (see main.py) so a fresh SQLite file always
has the demo content available.
"""
...
def seed_if_empty():
    ...
    try:
        ...
        for s in SCENARIOS:
            ...
            scenario = Scenario(character_id=char_by_slug[s["character_slug"]], **data)
            db.add(scenario)
