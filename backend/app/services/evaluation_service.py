...
Aggregates all per-turn scores stored on UserResponse rows (never fakes
numbers - always derived from what was actually stored during the
simulation) into a single EvaluationResult.
"""
from statistics import mean

from app.models.models import UserResponse, EmotionState
...
def build_evaluation(responses: list[UserResponse], emotion_states: list[EmotionState]) -> dict:
