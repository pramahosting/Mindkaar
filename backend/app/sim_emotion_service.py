"""
Emotion engine for the simulation feature.

Takes the LLM's (or demo fallback's) proposed character_emotion delta and
turns it into a full, clamped emotion dict, keeping anger / frustration /
trust / calmness consistent with each other even if the LLM only returned
a partial character_emotion object.
"""
